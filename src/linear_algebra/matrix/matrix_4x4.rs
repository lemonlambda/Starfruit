...
mod tests {
    ...
    #[test]
    fn operators() {
        let matrix = Matrix4x4::new(vec4![10 20 30 40], vec4![50 60 70 80], vec4![90 100 110 120], vec4![130 140 150 160]);
        assert_eq!(matrix + 10, Matrix4x4::new(vec4![20 30 40 50], vec4![60 70 80 90], vec4![100 110 120 130], vec4![140 150 160 170]));
        assert_eq!(matrix - 10, Matrix4x4::new(vec4![0 10 20 30], vec4![40 50 60 70], vec4![80 90 100 110], vec4![120 130 140 150]));
        assert_eq!(matrix * 10, Matrix4x4::new(vec4![100 200 300 400], vec4![500 600 700 800], vec4![900 1000 1100 1200], vec4![1300 1400 1500 1600]));
        assert_eq!(matrix / 10, Matrix4x4::new(vec4![1 2 3 4], vec4![5 6 7 8], vec4![9 10 11 12], vec4![13 14 15 16]));
    }
